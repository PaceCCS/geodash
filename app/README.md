...
The [dim](https://github.com/PaceCCS/dim) library compiles to WASM for client-side unit display and conversion, keeping unit handling consistent with the Zig core.
